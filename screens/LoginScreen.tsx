...
import { Activity, ActivitySquare, LucideIcon, User, Users } from 'lucide-react-native';
...
// ─── Roles disponibles ─────────────────────────────────────────────────────────
const ROLES: Role[] = [
    { id: 'senior', Icon: User, label: 'Adulto\nMayor' },
    { id: 'caregiver', Icon: Users, label: 'Cuidador' },
    { id: 'doctor', Icon: Activity, label: 'Médico' },
];

// ─── Sub-componente: Botón de Rol ──────────────────────────────────────────────
function RoleButton({ role, isActive, onPress }: RoleButtonProps) {
    const { id, Icon, label } = role;
    return (
        <TouchableOpacity
            ...
            >
                ...
                >
                    ...
                    <View style={styles.logoCircle}>
                        <ActivitySquare size={52} color={COLORS.primary} strokeWidth={1.8} />
                    </View>
